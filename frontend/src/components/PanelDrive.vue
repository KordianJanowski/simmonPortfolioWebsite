  ...
  <div>
    <div v-if="!isDeleteDriveImageLayer" class="p-20 flex flex-col w-full">
      ...
      <div class="flex flex-row flex-wrap">
        <router-link to="/add-drive-images" class="panel-info hover:bg-gray-600 cursor-pointer">
...
export default {
  ...
  //   // ).then(response => {
  //   //   this.driveImages = response.data
  //   // })
  // },
  methods: {
    async deleteDriveImage() {
      ...
      this.driveImages.splice(index, 1)

      this.toggleDeleteDriveImageLayer('')

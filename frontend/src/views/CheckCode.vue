    ...
    <div>
      <div class="w-full h-screen flex justify-center items-center">
        <div class="w-full max-w-sm m-10 sm:m-0 overflow-hidden bg-gray-700 py-10 rounded-lg shadow-md">
          <div class="px-6 py-4">
            <h2 class="text-3xl font-bold text-center mb-3 text-white">Do pobrania</h2>
            <p class="mt-1 text-center text-gray-300">Poniżej podaj twój kod dostępu aby pobrać wybrane zdjęcia</p>
